...
public enum VoidReportEntryStatus
{
    Approved,
    Pending,
}
...
/// </summary>
public sealed class VoidReportEntryRow
{
...
/// </summary>
public partial class RptVoidsReportOverlay : UserControl
{
    ...
    public RptVoidsReportOverlay(RptDashboardFilterSnapshot filters, Action onClose)
    {
    ...
    private static VoidReportEntryRow[] BuildDemoSeed(NumberFormatInfo nfi, string approvedLabel, string pendingLabel) =>
            new[]
            {
