-- =============================================================================================
-- Migration: RPT report catalog on POS_CONTROL (public.rpt_report_categories, public.rpt_reports)
-- Date: 2026-05-01
-- PostgreSQL 9.3. Idempotent seeds: INSERT ... WHERE NOT EXISTS.
-- Run on central POS_CONTROL database.
-- =============================================================================================
ROLLBACK;
BEGIN;
...
-- Categories (align with RptDashboardMain browse / recent CategoryId)
...
-- Reports (report_code matches RptDashboardMain seed ReportIds)
