...
-- Stock category: four browse-linked reports ---------------------------------
...
-- Wastage → profitability (browse position 4) -------------------------------
UPDATE public.rpt_reports SET
...
-- Procurement subgroup 1..5 (orange chrome) ---------------------------------
UPDATE public.rpt_reports SET
...
-- Profitability subgroup 1..5 (purple chrome), excluding rpt.revenue (NULL sort) --
UPDATE public.rpt_reports SET
    ui_icon_backdrop_hex = '#EDE9FE',
    ui_icon_foreground_hex = '#6D28D9',
    ui_hover_border_hex = '#8B5CF6',
