-- =============================================================================================
-- Migration: Sales browse subgroup — five reports (local / branch DB)
-- Date: 2026-05-12
...
-- New sales reports (idempotent inserts)
...
-- Move Revenue out of Sales browse (still available under Profitability category)
...
-- VAT Summary listed under Sales Reports browse (purple card theme unchanged)
UPDATE public.rpt_reports SET
...
-- Browse order for Sales: Daily (1), VAT (2), three new (3–5)
